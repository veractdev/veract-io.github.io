...
export default function Page() {
  ...
  const handleTileClick = (item: { name: string }) => {
    ...
    const filteredCardsArray = caseStudiesHomePageData.caseStudiesList[
      name as keyof typeof caseStudiesHomePageData.caseStudiesList
    ] as unknown as CaseStudyCard[];
