            ...
            <div id="portfolioDetails" className='fontFamily'>
                    <div className='caseDetails_mobile'>
                        <div className='caseHeader_mobile'>
                                {/* <div className='caseHeaderContent_mobile pb-11'><img src="portfolio/fintechPurple.png" className='w-48 pt-5'/></div> */}
                                <div className="pt-15">
                                <div className='caseHeaderTitle_mobile pl-5 pt-20'>Credit risk assessment and risk profiling</div>
                                </div>
                                
                            {/* </div> */}
                                <div className='caseHeaderIcon_mobile pt-11 pb-11 pl-2'>Northern Arc Capital is a platform in the financial services sector set up primarily with the mission of catering to the diverse credit requirements of under-served households and businesses.</div>
