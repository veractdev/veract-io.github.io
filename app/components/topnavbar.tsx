              ...
              <div className="flex nav-list fontFamilyNav  navFonts md:gap-10">
                ...
                <li className={`nav-item ${isOpen ? "visible" : "MediaHidden"}`}>
                  <div className={`nav-align ${isOpen ? "visible" : "MediaHidden"}`}>
                    <div className="flex items-center justify-center navbarCursor whitespace-nowrap" onClick={() => scrollToSection('Home')}><Link href="/" className="home" onClick={handleToggle}>Home</Link></div>
                ...
                <li className={`nav-item ${isOpen ? "visible" : "MediaHidden"}`}>
                  <div className={`nav-align ${isOpen ? "visible" : "MediaHidden"}`}>
                     <div className='flex items-center founder justify-center navbarCursor whitespace-nowrap pl-3'onClick={handleToggle}><div  onClick={() => scrollToSection("Founder's")}>Founder's Desk</div></div>
                ...
                <li className={`nav-item ${isOpen ? "visible" : "MediaHidden"}`}>
                  <div className={`nav-align ${isOpen ? "visible" : "MediaHidden"}`}>
                    <div className="flex items-center justify-center navbarCursor whitespace-nowrap pl-0" onClick={() => scrollToSection("Services")}><a  className="services " onClick={handleToggle}><span onClick={() => scrollToSection("Services")}>Services</span></a></div>
                ...
                <li className={`nav-item ${isOpen ? "visible" : "MediaHidden"}`}>
                  <div className={`nav-align ${isOpen ? "visible" : "MediaHidden"}`}>
                  <div className='flex items-center founder justify-center navbarCursor whitespace-nowrap pl-3'onClick={handleToggle}><div  onClick={() => scrollToSection("Testimonials")}>Clients Speak</div></div>
                  <div><hr className="testimonialsHr"></hr></div>
                  </div>
                </li>
                </div>
