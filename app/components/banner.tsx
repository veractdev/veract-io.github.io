...
export default function Banner() {
    ...
    return (
        <div className='bannerWidth flex flex-row justify-between items-center'>
            <div className="flex flex-col justify-between items-center customTextLandingPage w-full">
                ...
                <div className=" pt-10 md:gap-2">
                 <div className='typed'>
                  <div className='happyPath'>Crafting your happy path from concept to code</div>
