  ...
  return (
    <div className='w-full flex flex-col items-center justify-center relative'>
      {show && (
        <div
          ref={glowRef}
          className="fixed w-[80px] h-[119px] rounded-full bg-[#004FD1] opacity-80 pointer-events-none blur-[60px] mix-blend-screen z-[15]"
          style={{
      ...
      {/* Your Converted SVG with Hover Detection */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 20.34000015258789 156.69000244140625 33.59000015258789"
        data-asc="1.06884765625"
        // width="156.69000244140625"
        // height="33.59000015258789"
      ...
      >
        ...
        <g>
          <g fill="#1c1c1c">
            ...
            <g transform="translate(0, 64.6484375)">
              <path d="" />
            </g>
          </g>
        </g>
