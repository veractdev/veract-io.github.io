...
export default function Testimonials() {
  ...
  return (
    loader && (
      <div className="w-full h-max bg-[#0D0D0D] text-white flex items-center justify-center relative z-20 pb-[3rem] md:pb-0">
                  ...
                  <AnimatePresence key={index} mode='wait'>
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        <div className='leading-[19px]' dangerouslySetInnerHTML={{ __html: LandingPageData.testimonials.testimonial_list[activeIndex].quote }} />
                      </motion.div>
                    </motion.div>
                  </AnimatePresence>
                );
                    ...
                    {visibleMiniIndex === index ? (
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          <div className='leading-[19px]' dangerouslySetInnerHTML={{ __html: t.quote }} />
                        </motion.div>
                      </motion.div>
                    )}
                  </motion.button>
