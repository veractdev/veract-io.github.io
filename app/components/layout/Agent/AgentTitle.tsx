  ...
  return (
    loaded && (
      <div className="w-full h-max flex flex-col items-center justify-center gap-[45px] px-[70px] pt-[69px]">
          ...
          <div className="text-[#FAFAFA] text-center syneFont text-[54px] font-semibold leading-normal max-w-[1139px]">
            {title_description}
          </div>
          <div className="text-[#CECECE] text-center dmSansFont text-[26px] font-normal leading-normal pb-[136px] max-w-[652px]">
            {description}
          </div>
        </div>
    )
