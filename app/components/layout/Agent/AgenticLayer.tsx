      ...
      <div>
        ...
        <div className="flex md:flex-row flex-col items-center justify-center pb-[217px]">
          <div className="relative lg:w-[401px] lg:h-[401px] md:w-[13.66906rem] md:h-[14.25881rem] w-[218px] h-[218px] rounded-full flex items-center justify-center overflow-visible">
            ...
            <div
              className="absolute z-20 lg:top-[51px] lg:left-[51px] md:top-[1.77rem] md-[1.87rem] top-[1.25rem] lg:w-[394px] lg:h-[394px] md:w-[13.66906rem] md:h-[14.25881rem] w-[218px] h-[218px] pointer-events-none md:animate-agentic-layer"
              style={{
            ...
            <div className="absolute z-30 text-[#FAFAFA] syneFont lg:text-[60px] md:text-[30px] text-[26px] text-center font-semibold lg:leading-[60px] leading-[2.03863rem] lg:top-[176px] lg:left-[141px] lg:w-full w-[6.875rem] animate-agentic-layer-opacity">
              Ai Agent Layer
            </div>
          ...
          <div className="flex lg:top-[51px] lg:left-[54px] relative md:animate-agentic-layer-opacity">
            <img
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="blurry effect"
              className="absolute bottom-[-102px] left-[-54px] z-10 md:animate-agentic-layer-opacity md:opacity-100 opacity-0"
            />
            ...
            >
              <div className="flex flex-col lg:pl-[41px] pl-[1.8rem] lg:pr-[68px] pr-[2.99rem] lg:gap-[25px] gap-[1.1rem] lg:pb-[101px] pb-[4.54rem]">
                <div className="flex flex-row lg:gap-[13px] gap-[0.57181rem]">
                  <div>
                    <img
              ...
              <div className="text-white text-center dmSansFont lg:text-[20px] text-[0.875rem] font-normal leading-normal pl-[40px] pr-[52px] pb-[45px]">
                Your tools stay the same. The way you work changes forever!
              </div>
              <div className="lg:px-[58px] px-[2.55rem]">
                <div className="flex lg:w-[295px] w-[12.97625rem] lg:px-[14px] lg:py-[6px] px-[0.62rem] py-[0.26rem] justify-center items-center gap-[10px] bg-[#4285F4] lg:rounded-[10px] rounded-[0.43988rem] text-center dmSansFont lg:text-[20px] md:text-[0.69388rem] text-[0.875rem] font-normal leading-normal text-white">
