...
export default function OurProcess() {
    return (
        <div className='w-full mx-[1.875rem] p-[6.25rem_4.375rem] bg-[#222222] flex flex-col items-center'>
            ...
            <div className='max-w-[43.75rem] text-center syneFont font-normal text-[3.125rem] text-white leading-[1.1em] -tracking-[0.04em] py-[1.563rem_0.938rem]'>Our Simple, Smart, and Scalable Process</div>
            <div className='max-w-[37.5rem] text-center interFont font-medium text-[#CCCCCC] text-[1.125rem] leading-[1.5em] -tracking-[0.02em]'>We design, develop, and implement automation tools that help you work smarter, not harder</div>
                    ...
                    <div className='flex flex-col gap-[1.25rem] p-[1.25rem_1.875rem] rounded-[0.5rem] bg-[#0D0D0D]/80 shadow-[0px_0px_0px_1px_#222222_inset]'>
                        <div className='flex flex-col gap-[1rem]'>
                            ...
                            <div className='flex flex-col gap-[0.625rem]'>
                                ...
                                <div className='w-[23.75rem] interFont text-[1rem] text-[#CCCCCC] font-medium leading-[1.4em] -tracking-[0.02em]'>We assess your business goals, challenges, and processes to identify where custom AI agents deliver maximum impact.</div>
                            </div>
                        </div>
