  ...
  return (
    loaded && (
      <div ref={sectionRef} className="w-full p-[0rem_2.75rem_4rem_2.75rem] md:p-[6.25rem_4.375rem]  flex flex-col items-center">
        <div className="fade-in-up w-max p-[0.5rem_0.75rem] rounded-[0.375rem] bg-primary-text border-[1px] border-[#222222] figTreeFont text-[0.875rem] text-white font-medium leading-[1.2em] -tracking-[0.02em]">
          {AgentPageData.ourprocess.pageTitle}
        </div>
        <div className="fade-in-up max-w-[43.75rem] text-center syneFont font-medium md:font-normal text-[1.75rem] md:text-[3.125rem] text-white leading-[1.1em] -tracking-[0.04em] py-[1.563rem_0.938rem]">
          {AgentPageData.ourprocess.title}
        </div>
        <div className="fade-in-up max-w-[37.5rem] text-center interFont font-normal md:font-medium text-[#CCCCCC] text-[0.875rem] md:text-[1.125rem] leading-[1.5em] -tracking-[0.02em]">
                  ...
                  <div className="w-full h-[11.25rem] lg:py-[40px] lg:px-[38px] flex items-center justify-center">
                    <div className="flex flex-row justify-center items-center">
                      <div className="flex relative w-[64px] h-[64px] bg-[#0D0D0D]/80 border border-[#222222] rounded-[5px] items-center justify-center z-[200]">
                        ...
                        <div className="absolute top-[calc(100%+5px)] interFont text-[0.625rem] text-[#FFFFFFE6] font-regular leading-[1.1em] text-center">Our solution</div>
                      </div>
                      ...
                      <div className="relative flex justify-center items-center">
                        ...
                        <div className="absolute top-[calc(100%+5px)] interFont text-[0.625rem] text-[#FFFFFFE6] font-regular leading-[1.1em] z-[201] text-center">Your stack</div>
                      </div>
                    </div>
                  </div>
                )}
                {card.id === 4 && (
                  <div className="w-full h-[11.25rem] flex flex-row gap-[0.313rem] items-center justify-center">
                    <div className="w-[260px] h-[160px] border border-[#222222] px-[10px] py-[13px] flex flex-col gap-[10px]">
                      <div className="relative w-[240px] h-[38px] flex flex-row  items-center shadow-[0px_0px_0px_1px_#222222_inset] overflow-hidden rounded-[4px] pl-[5px]">
                        <div className="w-[201px] flex flex-row gap-[7px]">
                          <div className="w-[28px] h-[28px] rounded-[4px] bg-[#FFFFFF]/5 relative flex items-center justify-center ">
                        ...
                        <CircleNotch size={18} weight="bold" className="text-primary-blue animate-spin-slow absolute right-[5px]" />
                      </div>
                      <div className="relative w-[240px] h-[38px] flex flex-row  items-center shadow-[0px_0px_0px_1px_#222222_inset] overflow-hidden rounded-[4px] pl-[5px]">
                        <div className="w-[201px] flex flex-row gap-[7px]">
                          <div className="w-[28px] h-[28px] rounded-[4px] bg-[#FFFFFF]/5 relative flex items-center justify-center ">
                          ...
                          <div className="flex flex-col gap-[4px]">
                            <div className="text-[12px] text-white interFont font-medium leading-[1em] -tracking-[0.04em]">Workflow system</div>
                            <div className="text-[10px] text-white interFont font-regular leading-[1.1em] -tracking-[0.04em]">Update available..</div>
                          </div>
                        </div>
                        <div className="flex items-center justify-center overflow-hidden w-[19px] h-[19px] bg-[#FFFFFF]/5 rounded-[4px] absolute right-[5px]">
                          <ArrowUp size={18} weight="bold" className="text-primary-blue animate-arrow-upwards" />
                        </div>
                      </div>
                      <div className="relative w-[240px] h-[38px] flex flex-row  items-center shadow-[0px_0px_0px_1px_#222222_inset] overflow-hidden rounded-[4px] pl-[5px]">
                        <div className="w-[201px] flex flex-row gap-[7px]">
                          ...
                          <div className="flex flex-col gap-[4px]">
                            <div className="text-[12px] text-white interFont font-medium leading-[1em] -tracking-[0.04em]">Sales system</div>
                            <div className="text-[10px] text-white interFont font-regular leading-[1.1em] -tracking-[0.04em]">Up to date</div>
                          </div>
                        </div>
                        <Check size={18} weight="bold" className="text-primary-blue absolute right-[5px]" />
                      </div>
