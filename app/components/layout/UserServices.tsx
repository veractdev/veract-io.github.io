...
export default function UserServices() {
  ...
  return (
    <div className="flex justify-center flex-col items-center syneFont relative z-200 bg-[#0d0d0d] py-[4.5rem] md:py-[6.25rem] lg:py-[8.438rem]">
      ...
      <div className="flex lg:flex-row md:flex-col flex-col items-center justify-center lg:gap-[10px] gap-[15px] w-full">
        <div className="flex lg:w-max flex-col lg:gap-[10px] gap-[15px] w-full">
          {/* First row */}
