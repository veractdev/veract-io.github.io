...
export default function UserServices() {
  ...
  return (
    <div className="flex justify-center flex-col items-center">
      ...
      <div className="text-[36px] leading-[1.2em] w-[550px] text-center mb-[2.5rem] font-semibold">We built a <span className="text-[#4285f4]">focused solution</span> to transform livestock health monitoring.</div>
      <div className="flex flex-row items-center justify-center gap-[10px]">
        <div className="flex flex-col gap-[10px]">
          <div className="flex flex-row gap-[10px]">
            ...
            <div className="opacity-0 blob-placeholder left-[-3rem] top-[-3rem] absolute h-[30rem] w-[8rem] rotate-[18deg] overflow-hidden bg-white/5 backdrop-blur-[5rem] transition-all duration-300 ease-in"></div>
              <div className="absolute top-[1rem] left-[1rem] text-[26px] text-white transition-all duration-700 ease-in group-hover:top-[3rem] group-hover:left-[3rem] group-hover:bg-[linear-gradient(93deg,_rgb(31,139,255)_42.49%,_rgb(255,255,255)_100%)] group-hover:bg-clip-text group-hover:text-transparent w-[50%]">
