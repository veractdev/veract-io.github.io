    ...
    loaded && (
      <div className="w-full h-max flex flex-col lg:flex-row items-start justify-center md:gap-[3.125rem] p-[4.5rem_1.25rem_0_1.25rem] md:p-[10.25rem_3.25rem_0_3.25rem] lg:p-[4rem_0_0.125rem_0] relative z-50 bg-primary-text lg:pt-[6.25rem] md:pt-[6.25rem]">
        <div className="w-full lg:w-auto flex flex-col items-start justify-center gap-[1.875rem] md:gap-[2.5rem]">
          <div className="geistFont text-[0.875rem] md:text-[1rem] text-[#868586] font-semibold tracking-[0em] uppercase leading-[1.4em]">
        ...
        <div className="relative w-full lg:w-[45.313rem]">
          <div className="hidden md:block lg:blockw-full interFont text-[3.75rem] text-white opacity-[0.1] font-extrabold leading-[1em] tracking-[0em] uppercase text-right">
            {challenges_props.challenge_description}
          </div>
          <div className="flex flex-row items-center justify-between">
            <div className="hidden lg:block w-full basis-[13%] opacity-0">
              TEXT
            </div>
              ...
              {challenges_props.solution_list
                ...
                .map((challenge, index) => (
                  ...
                  >
                    ...
                    />
                    <div className="interFont text-[1rem] md:text-[0.875rem] lg:text-[1.125rem] font-medium text-white tracking-[-0.02em] leading-[1.4em] lg:leading-[1.5em]">
                      {challenge.title}
                    </div>
                  </div>
                ))}
