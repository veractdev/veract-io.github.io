...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* <title>
          Veract.co | AI, Agentic Systems & IoT Solutions for Digital Transformation
        </title> */}
        ...
        {/* <meta
          name="description"
          content="Veract.co empowers startups and businesses with Agentic AI, Machine Vision, and Industrial IoT solutions to automate workflows and accelerate innovation."
        /> */}
        <meta
          name="keywords"
        ...
        <meta name="twitter:title" content="Veract.co | AI, Agentic Systems & IoT Solutions for Digital Transformation" />
        ...
        <link rel="canonical" href="https://veract.co/" />
