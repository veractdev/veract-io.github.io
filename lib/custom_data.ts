...
export const caseStudiesHomePageData = {
  ...
  caseStudiesTitleList: [
    { id: 1, name: "Audio video", keyWord: 'audiovideo' },
    { id: 2, name: "Accessibility", keyWord: 'accessibility' },
    { id: 3, name: "Chat bot", keyWord: 'chatbot' },
    { id: 4, name: "Ed Tech", keyWord: 'edtech' },
    { id: 5, name: "Machine Vision", keyWord: 'machinevision' },
    { id: 6, name: "Wellness", keyWord: 'wellness' },
    { id: 7, name: "Industry Platform", keyWord: 'industryplatform' },
    { id: 8, name: "Manufacturing", keyWord: 'manufacturing' },
    { id: 9, name: "Agri Tech", keyWord: 'agritech' },
    { id: 10, name: "Ecommerce", keyWord: 'ecommerce' },
    { id: 11, name: "Sales", keyWord: 'sales' },
    { id: 12, name: "Audit", keyWord: 'audit' },
    { id: 13, name: "Fintech", keyWord: 'fintech' },
    { id: 14, name: "Thermal Vision", keyWord: 'thermalvision' },
  ],
  caseStudiesList: {
    audiovideo: [
      {
